  ...
  if (chapitreActif) {
    return (
      <div>
        ...
        <h3 className="font-bold text-gray-800 mb-4">{isGE ? '🌍' : isIST ? '🔬' : isVE ? '🤝' : '🏛️'} {chapitreActif.titre}</h3>
        {chargement ? (
...
export function AccueilEleve() {
  ...
  const afficherSectionsHiGe = matiereActive === 'HI' || matiereActive === 'GE' || matiereActive === 'SV' || matiereActive === 'IST' || matiereActive === 'VE';
