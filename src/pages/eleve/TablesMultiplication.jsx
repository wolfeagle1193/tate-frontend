...
// Tables disponibles par classe
const TABLES_CM1  = [2, 3, 4, 5];          // CM1 : tables du programme
const TABLES_CM2  = [2, 3, 4, 5, 6, 7, 8, 9];
const TABLES_6EME = [2, 3, 4, 5, 6, 7, 8, 9]; // révision

function getTablesForNiveau(niveau) {
  if (niveau === 'CM1') return TABLES_CM1;
  return TABLES_CM2; // CM2 et 6ème
}
      ...
      <div className="flex items-center gap-2 mb-5">
        ...
        <div>
          ...
          <div className="text-[11px] text-tate-terre/40">
            {niveau === 'CM1' ? 'Tables ×2 à ×5 · CM1' : niveau === '6eme' ? 'Révision tables ×2 à ×9 · 6ème' : 'Tables ×2 à ×9 · CM2'}
          </div>
        </div>
      </div>
